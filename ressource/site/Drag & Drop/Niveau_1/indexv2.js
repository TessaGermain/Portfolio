...
var count = 0;
function idImg(){
    var test = Math.round(Math.random() * (8 - 1) + 1);
...
for(var i = 0; i< 8; i++){
    document.getElementById('barre').innerHTML = document.getElementById('barre').innerHTML + '<img src="Image/img'+idUtilise[i]+'.png" alt="img'+idUtilise[i]+'" id="img_'+idUtilise[i]+'" draggable="true">';
}
...
function verifImage(){
    ...
    if(nbBonneImg == 8){
        if(nCoup == 0){
            ...
            document.getElementById('suivant').innerHTML = document.getElementById('suivant').innerHTML + '<a href="../Niveau_3/index.html">Puzzle Suivant</a>';
        }
        else{
            nCoup = nCoup+1;
        ...
        for(let i=1; i<9; i++){
            ...
            if(nCase[1] != nImg[1]){
                document.getElementById('barre').innerHTML = document.getElementById('barre').innerHTML + '<img src="Image/img'+nImg[1]+'.png" alt="img'+nImg[1]+'" id="'+idImg[0]+'" draggable="true">';
